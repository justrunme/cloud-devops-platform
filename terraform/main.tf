...
provider "kubernetes" {
  host                   = kind_cluster.default.kubeconfig_raw.host
  client_certificate     = kind_cluster.default.kubeconfig_raw.client_certificate
  client_key             = kind_cluster.default.kubeconfig_raw.client_key
  cluster_ca_certificate = kind_cluster.default.kubeconfig_raw.cluster_ca_certificate
}
